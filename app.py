...
class SentinelAPI:
    ...
    def get_incidents(self):
        url = f"https://management.usgovcloudapi.net/subscriptions/{self.subscription_id}/resourceGroups/{self.resource_group}/providers/Microsoft.OperationalInsights/workspaces/{self.workspace_name}/providers/Microsoft.SecurityInsights/incidents?api-version={sentinelapiversion}"
        response = requests.get(url, headers=self.get_headers())
        return response.json()

    def get_incident_details(self, incident_id):
        url = f"https://management.usgovcloudapi.net/subscriptions/{self.subscription_id}/resourceGroups/{self.resource_group}/providers/Microsoft.OperationalInsights/workspaces/{self.workspace_name}/providers/Microsoft.SecurityInsights/incidents/{incident_id}?api-version={sentinelapiversion}"
        response = requests.get(url, headers=self.get_headers())
        return response.json()

    def get_incident_alerts(self, incident_id):
        url = f"https://management.usgovcloudapi.net/subscriptions/{self.subscription_id}/resourceGroups/{self.resource_group}/providers/Microsoft.OperationalInsights/workspaces/{self.workspace_name}/providers/Microsoft.SecurityInsights/incidents/{incident_id}/alerts?api-version={sentinelapiversion}"
        response = requests.post(url, headers=self.get_headers())
        return response.json()

    def get_incident_entities(self, incident_id):
        url = f"https://management.usgovcloudapi.net/subscriptions/{self.subscription_id}/resourceGroups/{self.resource_group}/providers/Microsoft.OperationalInsights/workspaces/{self.workspace_name}/providers/Microsoft.SecurityInsights/incidents/{incident_id}/entities?api-version={sentinelapiversion}"
        response = requests.post(url, headers=self.get_headers())
        return response.json()

    def get_incident_relations(self, incident_id):
        url = f"https://management.usgovcloudapi.net/subscriptions/{self.subscription_id}/resourceGroups/{self.resource_group}/providers/Microsoft.OperationalInsights/workspaces/{self.workspace_name}/providers/Microsoft.SecurityInsights/incidents/{incident_id}/relations?api-version={sentinelapiversion}"
        response = requests.get(url, headers=self.get_headers())
        return response.json()
